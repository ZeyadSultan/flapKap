package task.flapKap.config;

import task.flapKap.exception.CustomAuthenticationEntryPoint;
import task.flapKap.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final String[] WHITE_LIST_ENDPOINTS = new String[]{"/api/login/**", "/api/signup/**"};
